...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Lacking exploration and experimentation.
    \end{itemize} 
    \item We need to shift to a design paradigm based on empiricism.
    \item Little knowledge on didactic approaches is available.%, we think an approach based on abductive reasoning works.
...
\begin{frame}{Some existing games related to software testing I}
\begin{figure}
    \centering
...
\begin{frame}{Some existing games related to software testing II}
\begin{figure}
    \centering
...
\begin{frame}{Some existing games related to software testing III}
\begin{figure}
    \centering
...
\begin{frame}{Some existing games related to software testing IV}
\begin{figure}
    \centering
...
\begin{frame}{Some existing games related to software testing V}
\begin{figure}
    \centering
...
\begin{frame}{Didactics for software testing:\\Abductive Reasoning I}
...
\begin{frame}{Didactics for software testing:\\Abductive Reasoning II}
    \begin{blockquote}
...
\begin{frame}{Didactics for software testing:\\Abductive Reasoning III}
...
\begin{frame}{Game based with Socrative Questioning}
    Based on Risk Storming~\cite{BibEntry2020Apr}:
    \begin{enumerate}
        \item Starting with a System Under Test.
        \item Identifying most relevant quality aspects.
        \item Identifying risks for these aspects, \textbf{supported with socrative questioning}.
...
\begin{frame}{Wheel of socrative questions}
    Functions as an intermediate moderator:
    \begin{figure}
        \centering
